...
var EditThirdComponent = /** @class */ (function () {
    ...
    EditThirdComponent.prototype.processFile = function (imageInput) {
        ...
        reader.addEventListener('load', function (event) {
            ...
            _this.http.post(_domain_enums_urlpath__WEBPACK_IMPORTED_MODULE_24__["UrlPath"].URL_PATH + "/servicebroker/v1/catalog/profile/changeimageprofile/" + userSession.idUserPublic + '/', formData).subscribe(function (res) {
                console.log(res);
